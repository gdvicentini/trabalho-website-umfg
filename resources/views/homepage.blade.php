...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="margin: 0 auto; display: flex; flex-direction: column; justify-content: center; align-items: center">
        ...
        <header class="container-top">
            <div style="display: flex; align-items: center; justify-content: space-between;">
                <div style="display: flex; align-items: center;">
                    <img src="{{ asset('storage/images/umfg-logo-cabecalho.png') }}" alt="">
                    <div style="width: 1px; background: gray; height: 70%"></div>
                    <p style="font-weight: bold; margin-left: 13px;">INFO</p>
                </div>
                <p class="admin-text">ACESSAR ÁREA ADMINISTRATIVA</p>
            </div>
        </header>

        <div class="content">
            <img src="{{ asset('storage/images/facec.png') }}" alt="">

            <div style="display: flex; align-items: center; margin: 23px 0px 23px 0px">
                <div style="width: 5px; height: 60px; background: black;"></div>
                <p style="font-weight: bold; margin-left: 10px; font-size: 30px">NOTÍCIAS UMFG</p>
            </div>

            <div class="container-noticias">
                <div class="noticias">
                    <img src="{{ asset('storage/images/post-page.png') }}" alt="">
            ...
            <div style="display: flex; align-items: center; ; margin: 23px 0px 23px 0px">
                <div style="width: 5px; height: 60px; background: black;"></div>
                <p style="font-weight: bold; margin-left: 10px; font-size: 30px">UMFG CURSOS</p>
            </div>

            <div class="container-cursos">
                <div class="blocos-cursos">
                    <img src="{{ asset('storage/images/icon-administracao.png') }}" alt="">
                ...
                <div class="blocos-cursos">
                    <img src="{{ asset('storage/images/icon-fisioterapia-ortopedica-amarelo.png') }}" alt="">
                    <h3 class="title-cianorte">CIANORTE</h3>
                    <h2 class="title-cursos">Fisioterapia</h2>
                    <p class="descricao-cursos">Formação profissional de alto nível, com capacidade crítica e reflexiva de suas ações e consciente de suas responsabilidades.</p>
                </div>
                <div class="blocos-cursos">
                    <img src="{{ asset('storage/images/icon-analise-e-desenvolvimento-de-sistemas.png') }}" alt="">
                    <h3 class="title-cianorte">CIANORTE</h3>
        ...
        <div class="footer-gray">
            <img style="width: 128px; height: 60px" src="{{ asset('storage/images/umfg-logo-rodape.png') }}" alt="">
        </div>
